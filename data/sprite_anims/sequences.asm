...
; entries correspond to SPRITE_ANIM_INDEX_* constants
	...
	db SPRITE_ANIM_FRAMESET_GS_INTRO_AERODACTYL,      SPRITE_ANIM_SEQ_GS_INTRO_AERODACTYL,         $00 ; SPRITE_ANIM_INDEX_GS_INTRO_AERODACTYL
	...
	db SPRITE_ANIM_FRAMESET_GS_INTRO_CHIKORITA,       SPRITE_ANIM_SEQ_GS_INTRO_CHIKORITA_PALSSIO,  $00 ; SPRITE_ANIM_INDEX_GS_INTRO_CHIKORITA
	db SPRITE_ANIM_FRAMESET_GS_INTRO_CUBBURN,         SPRITE_ANIM_SEQ_GS_INTRO_CUBBURN,            $00 ; SPRITE_ANIM_INDEX_GS_INTRO_CUBBURN
	db SPRITE_ANIM_FRAMESET_GS_INTRO_PALSSIO,         SPRITE_ANIM_SEQ_GS_INTRO_CHIKORITA_PALSSIO,  $00 ; SPRITE_ANIM_INDEX_GS_INTRO_PALSSIO
