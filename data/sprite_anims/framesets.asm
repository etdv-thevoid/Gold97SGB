...
ELIF DEF(_SILVER)
	frame SPRITE_ANIM_OAMSET_GS_INTRO_HO_OH_BLISSEY_2,  3
	frame SPRITE_ANIM_OAMSET_GS_INTRO_HO_OH_BLISSEY_1,  7
	frame SPRITE_ANIM_OAMSET_GS_INTRO_HO_OH_BLISSEY_2,  7
	frame SPRITE_ANIM_OAMSET_GS_INTRO_HO_OH_BLISSEY_3,  7
	frame SPRITE_ANIM_OAMSET_GS_INTRO_HO_OH_BLISSEY_3,  7
	frame SPRITE_ANIM_OAMSET_GS_INTRO_HO_OH_BLISSEY_4,  7
	frame SPRITE_ANIM_OAMSET_GS_INTRO_HO_OH_BLISSEY_4,  7
	frame SPRITE_ANIM_OAMSET_GS_INTRO_HO_OH_BLISSEY_3,  7
	frame SPRITE_ANIM_OAMSET_GS_INTRO_HO_OH_BLISSEY_2,  3
	dorestart
