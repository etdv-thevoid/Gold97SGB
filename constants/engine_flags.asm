...
; wUnlockedUnowns
	const ENGINE_UNLOCKED_UNOWNS_A_TO_H
	const ENGINE_UNLOCKED_UNOWNS_I_TO_P
	const ENGINE_UNLOCKED_UNOWNS_Q_TO_W
...
; wDailyFlags2
	...
	const ENGINE_DAILY_MOVE_TUTOR; use this for move tutor
